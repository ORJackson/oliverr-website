---
date: '2021-11-25'
thumbnail: /assets/stop-asian-hate.png
...
For an in-depth review of related literature please see the appendix.
...
For further reading on the background of this topic, including statistics and examples on the rise of anti-Asian sentiment and hate crimes on and offline, please see the appendix.
...
<h3>Background </h3>
People instinctively attribute blame to a group of people after a negative event. Blame is often reinforced by the media and may lead to discrimination towards that group of people. For example, a terrorist attack can be devastating for society. In the aftermath, negative sentiment is often felt by communities that are seen as having something in common with the perpetrators; for instance a common background or shared trait such as ethnicity or religion. The 9/11 attack on the World Trade Center in 2001 had extremely negative effects on Islamic and Arab communities within the United States. In the aftermath of 9/11, these communities were exposed to hate crimes that included harassment, death threats, physical violence and the burning and destruction of Mosques; from 2000 to 2001 the FBI recorded an increase in hate crimes toward Muslims of 1617% (Alfonseca, 2021). These repercussions continue to be felt today in America, and negative sentiment towards American-Muslim and American-Arab communities spikes whenever an extremist attack occurs overseas (Mekouar, 2022).

Just as terrorist attacks over the last two decades have caused a surge in Islamaphobic hate- crimes, the Covid-19 pandemic has seen a rise in hate crimes committed against Asian people. Anti-bullying charity Ditch the Label found a rise of 1662% in Asian-targeted hate speech online in 2020 compared to 2019 (Cipirska, 2021). The fact that Covid-19 was first discovered in China as well as the use of terms like “Chinese virus” and “Wuhan virus” by politicians and the media has caused an association between China and Asia with the virus, the pandemic, and all of the severe restrictions put in place to combat the spread. This negative association is seen as a probable cause of the documented increase in anti-Asian hate crimes (Yeh, 2020).

Over the last two years, Asian communities around the world have been feeling the rippling effects of negative sentiment caused by the pandemic. In the US in 2021, President Joe Biden signed the Covid-19 Hate Crimes Act to attempt to curtail the surge in hate crimes, felt particularly by Asian Americans (McCarthy, 2021). A report released in March 2021 by the advocacy group Stop AAPI Hate found that over the previous year over 6,600 hate crimes against American Asians had been reported; Chinese individuals were the most likely victims (43.7%) and reports of physical assault increased by 64% from the previous year (Jeung, Horse and Cayanan, n.d.). One of the most horrific events of its type in 2021 in America saw a Georgia man reportedly fatally shoot 8 people across 3 Atlanta spas, 6 of whom were of Asian descent. The District Attorney on the case is seeking enhanced sentencing under Georgia’s hate crimes law (Associated Press, 2021). 

In the UK anti-Asian sentiment fueled by the Covid-19 pandemic has similarly been on the rise.  In March 2020, a few months into the pandemic, a Singaporean student was physically assaulted in London, the perpetrator stated “we don’t want your Coronavirus in our country” (Cheng, 2020). Hate crimes against East and South-East Asian communities rose by 300%, a report by End The Virus of Racism found (Khan, 2021). Hate crimes and acts of racial violence have been perpetrated against not just Chinese people but anyone “sharing the perceived phenotype of “Chineseness”... light-skinned East and South-East Asians” (Yeh, 2020). A BBC investigation documenting the increase in anti-Asian hate crimes uncovered various forms of racial abuse including verbal harassment (telling a woman “you are the Chinese virus, go back to your country”), violent assault in the street, and a victim being spat on; this investigation attributes the rise in xenophobic attitudes to fear around coronavirus. Victims told the BBC that “the rhetoric of some leaders [has] caused enduring harm”, quoting Donald Trump who used terms like “Chinese virus” and “kung flu” and described China as “the nation that unleashed this plague upon the world”  (Swift, Motture and Bull, 2021).


<h3>Related Work </h3>
Sentiment analysis is the process of drawing meaning from text. To a human, understanding the meaning of a sentence may seem easy. However, the meaning of a word can change significantly when used in different contexts, extracting the meaning of a string of words based on their context when grouped together is a complex process. You can use a human to understand a single sentence, paragraph or even a book, but if you are to look for trends in thinking you need to analyse a larger data set; here computers can analyse a comparatively huge data set in much less time than a person. To do this you must train a computer to interpret meaning from text. As a field of machine learning, computers are used to interpret a text by examining the relationships between words. Sentiment analysis is a subfield of Natural Language Processing (NLP) that has been applied to the news, other media outlets, and social media to examine trends in thinking surrounding the Covid-19 pandemic.

Much evidence exists documenting the increase in hate speech, racism, and xenophobia directed towards Asian people online since the start of the Covid-19 pandemic. One paper written by Reuben Ng analysed over 30 million newspaper articles online from 20 countries and using sentiment analysis found evidence of societal shifts in sentiments towards Asian people, comparing the baseline period of October to December 2019 against the start of the pandemic from January to May 2020 (Ng, 2021). Ng found that pre-pandemic Jamaica and New Zealand showed the most signs of anti-Asian sentiment, whereas during the pandemic anti-Asian sentiment was highest in the US and Nigeria.

Several studies have used the Twitter Application Programming Interface (API) to extract data to examine sentiments towards Asians and have found that the increase in hate speech Asians are exposed to in person is reflected in the sentiment seen online.

Nguyen et al. collected over 3 million race-related tweets from the USA from November 2019 to June 2020 and carried out sentiment analysis using Support Vector Machine, a supervised machine learning model (Nguyen et al., 2020). Nguyen et al found that negative tweets referencing Asians increased by 68.4% during the period, whereas racist tweets referencing other ethnicities remained relatively stable. 

A study by Dubey examined over 16,000 tweets during April 2020 to examine the extent of cyber racism during the pandemic. Any tweet that mentioned “ChineseVirus”, “WuhanVirus” or “ChineseVirusCorona” was collected, and using a machine learning model analysed sentiment and found that the majority were negative and also found a sense of “fear, anger, and disgust among Twitter users” (Dubey, 2020). Dubey attributes Trump’s use of the term “Chinese Virus”  which gained significant momentum as causing an increase in hate speech online (Dubey, 2020).
